document.addEventListener('readystatechange',function(){
	if(document.readyState === 'complete'){
		...
		var musics = [
		{name:'时间都去哪儿了',src:'001.mp3',singer:'痛仰乐队',duration:'3:42'},
		{name:'归还',src:'002.mp3',singer:'冷子夕',duration:'4:18'},
		{name:'安徒生剧本',src:'003.mp3',singer:'蒋蒋',duration:'3:54'},
		{name:'我知道你很难过',src:'004.mp3',singer:'蔡依林',duration:'8:44'},
		{name:'淘汰',src:'005.mp3',singer:'陈奕迅',duration:'4:45'},
		{name:'你是我的风景',src:'006.mp3',singer:'何洁',duration:'4:09'},
		{name:'愿得一人心',src:'007.mp3',singer:'李行亮',duration:'4:37'},
		{name:'我很快乐',src:'008.mp3',singer:'刘惜君',duration:'3:33'},
		{name:'下辈子如果我还记得你',src:'009.mp3',singer:'马郁',duration:'3:48'},
		{name:'白天不懂夜的黑',src:'010.mp3',singer:'那英',duration:'4:02'},
		{name:'放开爱',src:'011.mp3',singer:'戚薇',duration:'3:43'},
		{name:'黑白之间',src:'012.mp3',singer:'戚薇',duration:'4:55'},
